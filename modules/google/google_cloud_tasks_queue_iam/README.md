...
# Google Cloud Tasks IAM Terraform Module

A [Terraform](https://www.terraform.io) module to create a [Google Cloud Tasks IAM](https://cloud.google.com/tasks/docs/reference-access-control) on [Google Cloud Services (GCP)](https://cloud.google.com/).
...
```hcl
module "google_cloud_tasks_queue_iam" {
  source = "github.com/mineiros-io/terraform-google-iam//modules/google/google_cloud_tasks_queue_iam?ref=v0.1.2"
...
- [**`name`**](#var-name): *(**Required** `string`)*<a name="var-name"></a>
  ...
  Name of Cloud Tasks Queue the IAM is applied to.
...
- [**`iam`**](#output-iam): *(`object(iam)`)*<a name="output-iam"></a>
  ...
  All attributes of the created `google_cloud_tasks_queue_iam_binding` or `google_cloud_tasks_queue_iam_member` or `google_cloud_tasks_queue_iam_policy` resource according to the mode.
...
[variables.tf]: https://github.com/mineiros-io/terraform-google-iam/blob/main/modules/google/google_cloud_tasks_queue_iam/variables.tf
