...
EOT
  ...
  title = "Google Cloud Tasks IAM Terraform Module"
  toc   = true
  section {
    content = <<-EOT
...
references {
  ...
  ref "variables.tf" {
    value = "https://github.com/mineiros-io/terraform-google-iam/blob/main/modules/google/google_cloud_tasks_queue_iam/variables.tf"
  }
  ref "issues" {
