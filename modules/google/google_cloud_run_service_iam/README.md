...
# Google Cloud Run IAM Terraform Module
...
module "google_cloud_run_service_iam" {
  source = "github.com/mineiros-io/terraform-google-iam//modules/google/google_cloud_run_service_iam?ref=v0.1.3"
...
- [**`service`**](#var-service): *(**Required** `string`)*<a name="var-service"></a>
  ...
  Name of Cloud Run resource the IAM is applied to.
...
[variables.tf]: https://github.com/mineiros-io/terraform-google-iam/blob/main/modules/google/google_cloud_run_service_iam/variables.tf
