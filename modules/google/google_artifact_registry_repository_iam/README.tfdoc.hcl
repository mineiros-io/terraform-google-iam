...
EOT
  ...
  title = "Google Artifact Registry Repository IAM Terraform Module"
  toc   = true
  section {
    content = <<-EOT
...
module "google_artifact_registry_repository_iam" {
  source = "github.com/mineiros-io/terraform-google-iam//modules/google/google_artifact_registry_repository_iam?ref=v0.1.1"
...
references {
  ...
  ref "variables.tf" {
    value = "https://github.com/mineiros-io/terraform-google-iam/blob/main/modules/google/google_artifact_registry_repository_iam/variables.tf"
  }
  ref "issues" {
