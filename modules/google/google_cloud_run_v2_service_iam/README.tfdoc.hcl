...
EOT
  ...
  title = "Google Cloud Run V2 Service IAM Terraform Module"
  toc   = true
  section {
    content = <<-EOT
...
module "google_cloud_run_v2_service_iam" {
  source = "github.com/mineiros-io/terraform-google-iam//modules/google/google_cloud_run_v2_service_iam?ref=v0.1.3"
...
references {
  ...
  ref "variables.tf" {
    value = "https://github.com/mineiros-io/terraform-google-iam/blob/main/modules/google/google_cloud_run_v2_service_iam/variables.tf"
  }
  ref "issues" {
